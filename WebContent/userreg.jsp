...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			...
			<form id="regForm" name="form2" action="RegServlet" method="post" onSubmit="return reg()">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
          
              <tr>
                <td width="42%" height="25" align="right" class="field">用户名*：</td>
                <td width="58%" height="25">&nbsp;<input class="text" type="text" name="userId"  id="userId"></td>
              </tr>
              <tr>
                <td width="42%" height="25" align="right" class="field">密码*：</td>
                <td height="25" class="tabletd2">&nbsp;<input class="text" type="password" id="password" name="password"></td>
              </tr>
               <tr>
                <td width="42%" height="25" align="right" class="field">确认密码*：</td>
                <td height="25" height="25" class="tabletd2">&nbsp;<input class="text" type="password" name="confirmPassword"></td>
              </tr>
              <tr>
                <td height="25" align="right" class="field">性别：</td>
                <td height="25" class="tabletd2">&nbsp;
                <input name="gender" type="radio" value="0" checked>&nbsp;男</input>
                <input type="radio" name="gender" value="1">&nbsp;女</input></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="25" class="tabletd2">&nbsp;<input class="text" type="text" name="address"></td>
              </tr>
					<tr>
						<td></td>
